...
2. 🎉 Merged PR [#2](https://github.com/KunHwanAhn/next-image-opt-example/pull/2) in [KunHwanAhn/next-image-opt-example](https://github.com/KunHwanAhn/next-image-opt-example)<br>
